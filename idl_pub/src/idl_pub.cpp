...
public:
  ...
  {
//gean    publisher_ = this->create_publisher<idl_msgs::idl::StringMsg>("chatter", 10);
    publisher_ = this->create_publisher<idl_msgs::idl::StringMsg>("chatter", rmw_qos_profile_sensor_data);
