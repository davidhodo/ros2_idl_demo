...
#include "StringMsgSubscriber.h"

using namespace eprosima::fastrtps;
using namespace eprosima::fastrtps::rtps;

StringMsgSubscriber::StringMsgSubscriber() : mp_participant(nullptr), mp_subscriber(nullptr) {}

StringMsgSubscriber::~StringMsgSubscriber() {	Domain::removeParticipant(mp_participant);}

bool StringMsgSubscriber::init()
{
...
void StringMsgSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
