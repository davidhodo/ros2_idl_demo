...
#ifndef _IDL_MSGS_IDL_TIMESTAMP_PUBSUBTYPES_H_
#define _IDL_MSGS_IDL_TIMESTAMP_PUBSUBTYPES_H_
...
#error Generated Timestamp is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace idl_msgs
{
    namespace idl
    {
         ...
         * @ingroup TIMESTAMP
         */
        class TimestampPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
...
#endif // _IDL_MSGS_IDL_TIMESTAMP_PUBSUBTYPES_H_